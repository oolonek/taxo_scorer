...
df <- split(Sirius_tax_STDS_entry_random, sample(1 : 8, nrow(Sirius_tax_STDS_entry_random), replace = TRUE))
```
...
Sirius_tax_STDS_degraded_08 <- rbind(df$`1`, df$`2`, df$`3`, df$`4`, df$`5`, df$`6`, df$`7`, df$`8`)
```
