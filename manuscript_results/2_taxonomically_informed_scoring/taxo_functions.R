...
TaxoWeighter <- function(score_kin, score_phy, score_cla, score_ord, score_fam, score_gen, score_spe, dfsel)
  {
...
TaxoWeighter_UseR <- function(score_kin, score_phy, score_cla, score_ord, score_fam, score_gen, score_spe, dfsel)
{
  df <- as.data.frame(dfsel)
  # appends a column name indicating the applied score
  new_colname_kin <- paste0('MatchVal_Kin_', as.name(score_kin), collapse = NULL)
